...
def getPath():
    ...
    if not fileList:
        print("The input is neither ktest format file nor folder that "
              "include ktest format file.\n")
        printUsage()
    return fileList
...
def printUsage():
    ...
    print("Remove header of ktest format file, and save the new binary file "
          "as .seed file.\n")
    print("Argument:")
    print("<KtestFile>                          the path of .ktest file.")
    print("<KtestFile1> <KtestFile2> ...        the paths of .ktest files.")
    print("<KtestFolder>                        the path of folder contains "
          ".ktest file.")
    print("<KtestFolder1> <KtestFolder2> ...    the paths of folders contain "
          ".ktest file.")
