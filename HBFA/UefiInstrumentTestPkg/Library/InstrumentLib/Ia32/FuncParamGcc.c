...
{
  ExitContext.Ia32->Ebx = (UINT32)RetVal;
  ExitContext.Ia32->Esi = (UINT32)RShiftU64(RetVal, 32);
}
...
{
  return (UINT64)ExitContext.Ia32->Ebx + RShiftU64(ExitContext.Ia32->Esi, 32);
}
