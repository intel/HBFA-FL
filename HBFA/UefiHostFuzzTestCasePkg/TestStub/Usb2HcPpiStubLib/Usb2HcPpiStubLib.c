...
EFI_STATUS
EFIAPI
Usb2HcPpiStubGetRootHubPortNumber (
  IN  EFI_PEI_SERVICES              **PeiServices,
  IN  PEI_USB2_HOST_CONTROLLER_PPI  *This,
  OUT UINT8                         *PortNumber
  )
{
  DEBUG ((DEBUG_INFO, "USB_STUB: GetRootHubPortNumber\n"));
  return EFI_UNSUPPORTED;
}

EFI_STATUS
EFIAPI
Usb2HcPpiStubGetRootHubPortStatus (
  IN  EFI_PEI_SERVICES              **PeiServices,
  IN  PEI_USB2_HOST_CONTROLLER_PPI  *This,
  IN  UINT8                         PortNumber,
...
EFI_STATUS
EFIAPI
Usb2HcPpiStubSetRootHubPortFeature (
  IN EFI_PEI_SERVICES               **PeiServices,
  IN PEI_USB2_HOST_CONTROLLER_PPI   *This,
  IN UINT8                          PortNumber,
...
EFI_STATUS
EFIAPI
Usb2HcPpiStubClearRootHubPortFeature (
  IN EFI_PEI_SERVICES               **PeiServices,
  IN PEI_USB2_HOST_CONTROLLER_PPI   *This,
  IN UINT8                          PortNumber,
  IN EFI_USB_PORT_FEATURE           PortFeature
...
PEI_USB2_HOST_CONTROLLER_PPI       mUsb2HcPpiStub = {
  Usb2HcPpiStubControlTransfer,
  Usb2HcPpiStubBulkTransfer,
  Usb2HcPpiStubGetRootHubPortNumber,
  Usb2HcPpiStubGetRootHubPortStatus,
...
Usb2HcPpiStubInitialize (
  ...
  OUT PEI_USB2_HOST_CONTROLLER_PPI **Usb2HcPpi
  )
{
